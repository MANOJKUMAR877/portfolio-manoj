        ...
        <div className="row">
            ...
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">
                  Software Developer - ( HumanAize || Amicocon) - work student
                </h1>
                <h1 className="service__text">From (01/06/2022 - Till Date)</h1>
                <p className="p service__text p__color top">
                ...
                <p className="p service__text p__color top">
                  Present architectural recommendations to the Architecture
                  Review Board. Work with QA to ensure the quality of the
                  features, including the creation and maintenance of test
                  cases.
                </p>
                <p className="p service__text p__color top">
                  Own a feature through the development life-cycle, from
                  requirements gathering to implementation, testing, and
                  post-release support. Proactively Identify risks and failure
                  modes early in the development lifecycle and develop POCs to
                  mitigate the risks early in the program
                </p>

                <p className="p service__text p__color top">
                  Update the daily tasks in close collaboration with the CTO,
                  and participate with him in planning the upcoming sprint and
                  UI components{" "}
                </p>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">
                  Software Developer - (Kyra Technology by PRLX WEB)
                </h1>
                <h1 className="service__text">
                  From (02/06/2021 - 31/01/2022)
                </h1>
                <p className="p service__text p__color top">
